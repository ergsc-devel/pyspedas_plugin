...
- erg_lepe_l2_3dflux_FEDU
  - sample command: timespan, '2017-05-01' & erg_load_lepe, level='l2', datatype='3dflux'
...
- erg_lepe_l3_pa_pabin_??(??:01,01,..16)_FEDU
  - sample command: timespan, '2017-05-01' & erg_load_lepe, level='l3',/et_diagram
  - ytitle='ERG LEP-e!c'+string(pa_arr[j],'(f7.3)')+' deg!CEnergy'
  - ylim, 19, 21*1e3, 1
  - zlim, 1, 1e6, 1
- erg_lepe_l3_pa_enech_??(??:01,01,..32)_FEDU
  - sample command: timespan, '2017-05-01' & erg_load_lepe, level='l3'
