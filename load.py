...
def load(trange=['2017-03-27', '2017-03-28'], 
    ...
    if instrument == 'mgf':
        ...
        if level == 'l3':
            pathformat = 'satellite/erg/'+instrument+'/'+level+'/pa/%Y/%m/erg_'+instrument+'_'+level+'_pa_%Y%m%d_v??_??.cdf'
    elif instrument == 'orb':
        if level == 'l3':
            pathformat = 'satellite/erg/'+instrument+'/'+level+'/opq/%Y/%m/erg_'+instrument+'_'+level+'_op_%Y%m%d_v??.cdf'
        elif level == 'l2':
            pathformat = 'satellite/erg/'+instrument+'/def/%Y/erg_'+instrument+'_'+level+'_%Y%m%d_v??.cdf'
