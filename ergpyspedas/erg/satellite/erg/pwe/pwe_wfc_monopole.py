...
def pwe_wfc_monopole(trange=['2017-04-01/12:00:00', '2017-04-01/13:00:00'],
            datatype='waveform',
            mode='65khz',
            level='l2',
            suffix='',
    ...
    if level == 'l2':
        if datatype == 'waveform':
            ...
            tplot_name_list += [prefix + 'Ev1_waveform', prefix + 'Ev2_waveform']
            ...
            component_suffix_list.append('E_spectra')
