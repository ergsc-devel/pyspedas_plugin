...
def isee_vlf(
    ...
    """
    Load ISEE VLF data from the ERG-SC website.
    ...
    site: str or list of str
            The site or list of sites to load. Valid values: 'ath', 'ang', 'gak', 'hus', 'ist', 'kap', 'mam', 'mos', 'nai', 'ouj', 'all'
            Default: ['all']
    ...
    site_code_all = ["ath", "ang", "gak", "hus", "ist", "kap", "mam", "mos", "nai", "ouj"]
