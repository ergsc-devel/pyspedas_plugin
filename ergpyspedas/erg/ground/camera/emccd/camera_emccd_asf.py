            ...
            if current_tplot_name in loaded_data:
                ...
                if mapping_table:
                    ...
                    if meta_data_var is not None:
                        ...
                        mapping_table_structure[site_input]['glat'] = cdfcont.MaxRec + 1
                        mapping_table_structure[site_input]['glon'] = cdfcont.MaxRec + 1
                        mapping_table_structure[site_input]['altitude'] = cdfcont.MaxRec + 1
