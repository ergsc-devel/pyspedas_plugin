...
def plot_emccd_image(
    ...
    times, raw_data = get_data(v_name)
    ...
    fig.text(x=0.5, y=0.860, s=time_string(current_time), ha='center')
    fig.text(x=0.5, y=0.885, s=title, ha='center')
    fig.text(x=0.5, y=0.910, s=f'Station: {site.upper()}', ha='center')
